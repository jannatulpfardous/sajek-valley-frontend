    ...
    <div>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
          <p> <span style={{ fontFamily: "Besley" , color: "white"}}>Travel</span> <span style={{ color: "#4d4dfa", fontFamily: "Besley" }}> Nation </span></p>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 m-4">
              ...
              <li class="nav-item mx-2">
                <Link to="/facilities" class="nav-link active" aria-current="page" ><span style={{ fontFamily: "Besley" }}>About</span></Link>
              </li>
              ...
              <li class="nav-item mx-2">
                <Link to="/admin" class="nav-link" ><span style={{ color: "#faf7f9", fontFamily: "Besley" }}> <button className=" mb-3 btn btn-primary">Admin</button></span></Link>
              </li>
